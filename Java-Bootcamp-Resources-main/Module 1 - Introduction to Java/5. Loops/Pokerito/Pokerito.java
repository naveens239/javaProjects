    ...
    public static void main(String[] args) {
        ...
        */
        ...
        for (int i=0; i<=5; i++){
            ...
            System.out.println("\n\n"+card);
            if (card.equals(yourCard)){
                yourMatches++;
            }else if(card.equals(compCard)){
                computerMatches++;
            } 
        }
        ...
        if (yourMatches > computerMatches){
            System.out.println("You win with score of "+yourMatches+" points!");
        }else if (yourMatches < computerMatches){
            System.out.println("Computer wins with score of "+computerMatches+" points!");
        }else  {
