...
public class BuiltInFunctions {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Does it start with prefix Java? "+doesStartWithPrefix);
        ...
        System.out.println("Square of "+number+ " is "+sqrt);
        ...
        System.out.println("power of 2 raised to 3 is "+ power);
        ...
        System.out.println("Random number between 0.0 and 1.0 is "+randomNumber);
        ...
        System.out.println("greater number between "+ number1+" and "+number2+" is "+maxNumber);
